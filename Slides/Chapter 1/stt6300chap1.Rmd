...
parameter values of the population
* One of the simplest examples of a statistic is the arithmetic mean: 
$$\bar{x} = \frac{x_1 + \dots + x_n}{n}$$
* Other examples include measures of location (e.g., the median), measures of central tendency (e.g., the variance, the MAD/MADN estimators, and the IQR), and various correlation measures